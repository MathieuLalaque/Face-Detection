...
'''
def visualize_and_blur(input, faces, fps, thickness=2):
...
if __name__ == '__main__':
    ...
    if args.image1 is not None:
        ...
        n = 8
        partition = init_partition(n,(frameHeight,frameWidth))
        ...
        while cv.waitKey(1) < 0:
            ...
            if faces[1] is not None:
                ...
                visualize_and_blur(frame,coords,score,tm.getFPS(),partition,latence)

                latence -= 1

            #see partition

            frame = draw_lines(frame,n,(frameHeight,frameWidth))
